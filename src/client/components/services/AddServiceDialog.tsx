...
import { ServiceTemplate, ServiceNode, Secret } from "@/shared/schema/types";
...
interface AddServiceDialogProps {
  onAdd: (service: Omit<ServiceNode, "id">, secrets?: Secret[]) => void;
      ...
      <DialogTrigger render={trigger || (
        <button 
          className={cn(
            ...
            "h-9 px-4 border-dashed hover:border-primary hover:bg-primary/5 hover:text-primary transition-all gap-2"
          )}
        >
