                    ...
                    service.secrets.map((secret) => (
                      <TableRow key={secret.key} className="border-zinc-800 group hover:bg-zinc-900/40 transition-colors">
                        ...
                        <TableCell className="font-mono text-sm">
                          <div className="flex items-center gap-2">
                            <div className="flex-1 px-3 py-1.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400 overflow-hidden text-ellipsis whitespace-nowrap group-hover:border-zinc-700 transition-colors">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-900/30 flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">Manage làm thế nào service này liên quan đến các service khác.</p>
                  </div>
